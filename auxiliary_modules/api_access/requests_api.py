...
"""
Both get_json and SessionWithHeaderRedirection were inherited from datasources-etl.
They were used to work with srtm data. We do not use srtm data now. But we might in the future.
"""
# TODO: either use these functions with srtm or delete them.
