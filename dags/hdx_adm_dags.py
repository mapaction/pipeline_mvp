...
from airflow.operators.pipeline_plugin import HDXAdm0TransformOperator, HDXAdm1TransformOperator, HDXExtractOperator
...
with DAG('hdx_adm', schedule_interval=schedule_interval, catchup=catchup, default_args=default_args) as dag:
