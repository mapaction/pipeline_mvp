...
def create_hdx_adm_dag(countries, schedule_interval, catchup, default_args):
    ...
    for country in countries:
        ...
        adm0_transform = HDXAdm0TransformOperator(
            ...
            output_filename=os.path.join(dag.dag_id, country, config.get_adm0_cod_processed_filename(country=country)),
        ...
        adm1_transform = HDXAdm1TransformOperator(
            ...
            output_filename=os.path.join(dag.dag_id, country, config.get_adm1_cod_processed_filename(country=country)),
            iso3=config.get_iso3(country=country),
